...
##    __tablename__ = 'v_threads'# TODO: Make general to work for any board
##    thread_num = sqlalchemy.Column(sqlalchemy.columns.Integer)
##    posts = sqlalchemy.Column(sqlalchemy.columns.JSON)
##    last_post_num = sqlalchemy.Column(sqlalchemy.columns.Integer)
